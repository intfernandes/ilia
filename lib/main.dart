...
IInjector get injector => AutoInjectorImpl();

void main() async {
  CreateTransactionUc createTransactionn = injector.get<CreateTransactionUc>();

  final createTransaction = CreateTransactionUc(
